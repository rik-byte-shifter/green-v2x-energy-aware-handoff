...
\item \textbf{Scaling scenario correction}: \texttt{run\_scaling\_experiment()} now uses \texttt{SimulationConfig.scaling\_scenario()} to avoid sparse-coverage collapse at high load.
